...
function ajaxgetService(ajaxParameter){
	$.ajax({
			...
			error:function (XMLHttpRequest, textStatus, errorThrown){
                if (ajaxParameter.errorBack) {
                    ajaxParameter.errorBack();
                }
...
function ajaxpostService(ajaxParameter){
    $.ajax({
            ...
            error:function (XMLHttpRequest, textStatus, errorThrown){
                if (ajaxParameter.errorBack != undefined) {
                    ajaxParameter.errorBack(errorMessage);
                }
                console.log("请求服务[" + ajaxParameter.url + "]错误：textStatus:" + textStatus + "|errorThrown:" + errorThrown);
            }
        }
 ...
 * @constructor
 */
function DataColumn(columnName,columnType,columnLength,parentUri,displayName){
    //列名
...
;(function($, win){
     ...
     */
    DesignerTools.prototype.formatTime = function(time) {
