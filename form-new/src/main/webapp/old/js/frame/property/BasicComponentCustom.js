...
function ComponentBlockAlignProperty(componentObject) {
    ...
    this.getHtml = function () {
        var html = [];
        html.push("<div class=\"btn-group\">");
        html.push("<button id=\"" + this.idLeft + "\" type=\"button\" class=\"btn btn-default\" aria-label=\"layout-block-align-left\"><span class=\"glyphicon glyphicon-align-left\" aria-hidden=\"true\" id=\"" + this.idLeftSpan + "\"></span></button>");
        html.push("<button id=\"" + this.idCenter + "\" type=\"button\" class=\"btn btn-default\" aria-label=\"layout-block-align-center\"><span class=\"glyphicon glyphicon-align-center\" aria-hidden=\"true\" id=\"" + this.idCenterSpan + "\"></span></button>");
        html.push("<button id=\"" + this.idRight + "\" type=\"button\" class=\"btn btn-default\" aria-label=\"layout-block-align-right\"><span class=\"glyphicon glyphicon-align-right\" aria-hidden=\"true\" id=\"" + this.idRightSpan + "\"></span></button>");
        html.push("</div>");
