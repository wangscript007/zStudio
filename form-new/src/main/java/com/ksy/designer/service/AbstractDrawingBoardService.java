...
import com.ksy.designer.entity.form.FormDrawingBoard;

@Service
public class AbstractDrawingBoardService {
    private static final Logger LOGGER = Logger.getLogger(AbstractDrawingBoardService.class.getName());
    @Resource
