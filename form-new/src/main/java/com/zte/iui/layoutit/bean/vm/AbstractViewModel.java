...
//	}
	...
	public void getVMPropertyCode(StringBuffer result, String subKeyPath,
		...
		if (subField.getType().equalsIgnoreCase("object")) {
			result.append("{");
		} else if (subField.getType().equalsIgnoreCase("array")) {
			result.append("[{");
		} else {
	...
	private String getVMComputeProperty(Field field, String ftStr,String subKey) {
		...
		StringBuffer buffer = new StringBuffer();
		if (field.getType().equals("int") || field.getType().equals("bit")) {
...
//		if(field.getType().equalsIgnoreCase("array") || field.getParentType().equalsIgnoreCase("array")){
//			buffer.append("");
//		}else{
//			buffer.append(", \n").append(ftStr + subKey).append("_form_disabled : false");
//		}

		if (field.getComponentType().equalsIgnoreCase("multipleselect")
				|| field.getComponentType().equalsIgnoreCase("checkbox")) {
			buffer.append(",\n");
