...
public class QueryTableFieldServiceTest {
    ...
    private MysqlTableMessageSqlService mysqlService;
    ...
    public void setUp() {
        ...
        mysqlService = mock(MysqlTableMessageSqlService.class);
        ...
        tableFieldService.setUT_TableMessageSqlService(mysqlService);
        tableFieldService.setUT_multiTableUtilService(multiTableUtilService);

        when(mysqlService.getDatabaseName(databaseName)).thenReturn(databaseName);
    }
    ...
    @Test
    public void should_return_empty_on_mysql_single_table_when_query_table_field_return_empty() {
        // give
        mock_find_muiltResource_return_empty();
        when(metaDataMapper.querytablefield(sql)).thenReturn(new ArrayList<LinkedHashMap<String, Object>>());
        should_return_empty_on_mysql(failedMessage);
    }

    @Test
    public void should_return_empty_on_mysql_multi_table_when_query_table_field_return_empty() {
        // give
        mock_find_muiltResource_return_value();
        when(metaDataMapper.queryMultiField(sql)).thenReturn(new ArrayList<LinkedHashMap<String, Object>>());
        should_return_empty_on_mysql(failedMessage);
    }
    ...
    @Test
    public void should_return_empty_on_mysql_single_table_when_query_table_field_exception() {
        // give
        mock_find_muiltResource_return_empty();
        doThrow(new RuntimeException("MockException")).when(metaDataMapper).querytablefield(sql);
        should_return_empty_on_mysql_single_table("MockException");
    }

    @Test
    public void should_return_empty_on_mysql_multi_table_when_query_table_field_exception() {
        // give
        mock_find_muiltResource_return_value();
        doThrow(new RuntimeException("MockException")).when(metaDataMapper).queryMultiField(sql);
        should_return_empty_on_mysql_multi_table("MockException");
    }

    private void should_return_empty_on_mysql_single_table(String message) {
        when(mysqlService.getTableField(resourceName, databaseName)).thenReturn(sql);
        should_return_empty_on_mysql(message);
    }

    private void should_return_empty_on_mysql_multi_table(String message) {
        when(mysqlService.getMultiField(resourceName, databaseName)).thenReturn(sql);
        should_return_empty_on_mysql(message);
    }

    private void should_return_empty_on_mysql(String message) {
        mock_mysql();
    ...
    /** 查询到结果的场景 **/
    @Test
    public void should_return_fields_on_mysql_signle_table_when_find_empty_multiResource() {
        mock_find_muiltResource_return_empty();
        should_return_fields_on_mysql_signle_table();
    }

    @Test
    public void should_return_fields_on_mysql_signle_table_when_find_null_multiResource() {
        mock_find_muiltResource_return_null();
        should_return_fields_on_mysql_signle_table();
    }

    @Test
    public void should_return_fields_on_mysql_multi_table_when_find_empty_multiResource() {
        mock_find_muiltResource_return_value();
        should_return_fields_on_mysql_multi_table();
    }

    private void should_return_fields_on_mysql_signle_table() {
        mock_mysql();
        when(mysqlService.getTableField(resourceName, databaseName)).thenReturn(sql);
        should_return_fields_on_signle_table();
    }

    private void should_return_fields_on_mysql_multi_table() {
        mock_mysql();
        when(mysqlService.getMultiField(resourceName, databaseName)).thenReturn(sql);
    ...
    private void mock_mysql() {
        when(propertyService.getDbSchema()).thenReturn(DBConst.MYSQL);
    }
