...
public class ExeCmdManager {
    ...
    public int exeCmd() throws MaoCommonException {
        return exeCmd(true);
    }
     ...
     */
    public int exeCmd(boolean showCMD) throws MaoCommonException {
        ...
        try {
            ...
            throw new MaoCommonException("Fail to run command:" + commandForShow, e);
        }
        if (lineParser == null) {
