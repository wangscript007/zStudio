...
(function($, win) {
    ...
    var Bar = function(config, propertiesConfig) {
        this.schema = {};
        this.ctrlItems = {};
    ...
    datavisual.extend(Bar, win.datavisual.plugin.ChartBase);

    /**
     * api
     */
    Bar.prototype.getCssClass = function () {
        return "zdata_bar";
    };
     ...
     * @private
     */
    Bar.prototype._getControlPanelHtmlString = function() {
        var html = [];
     ...
     * api
     */
    Bar.prototype.getDesignFileContent = function() {
        var data = {};
    ...
    Bar.prototype._onControlItemAdded = function(ctrlItem) {
     ...
     * 处理控制项的移除事件
     */
    Bar.prototype.onControlItemRemoved = function(ctrlItem) {
        if ($.inArray(ctrlItem.getCtrlItemType(), SCHEMA_TYPE_ARRAY) != -1) {
     ...
     */
    Bar.prototype.onControlItemUpdated = function(ctrlItem) {
        // 直接全部覆盖原来的schema对象
        var type = ctrlItem.getCtrlType() == DATA_MODEL.FIELD_TYPE_METRIC ? 'value' : 'category';
        var schemaItem = {
            fieldName: ctrlItem.getFieldName(),
	...
	Bar.prototype._updateHavingStatus = function() {
     ...
     * }
     */
    Bar.prototype._checkDroppable = function(dropData) {
    ...
    Bar.prototype._clearCtrlItems = function () {
        //移除ctrlItem
        this.schema = {};
        this.ctrlItems = {};
        this.schema[SCHEMA_TYPE_WHERE] = [];
    ...
    Bar.prototype._isValid = function () {
        var result = {
            isValid: true,
            errorMessages: []
        };
     ...
     */
    Bar.prototype._getDataOption = function() {
        if (this.schema[SCHEMA_TYPE_Y_AXIS] == null || this.schema[SCHEMA_TYPE_Y_AXIS] == undefined ||
    ...
    Bar.prototype._getQueryCondArr = function(){
    ...
    Bar.prototype._transformData = function(transformRule, data) {
    ...
    Bar.prototype._transformDataXVYV = function(xAxis, yAxis, legend, data) {
        var legendData = [];
        if  (legend) {
    ...
    Bar.prototype._transformDataXVYC = function(xAxis, yAxis, legend, data) {
        var legendData = [];
        if  (legend) {
            $.each(data, function(index, item) {
                legendData.push(item[legend.fieldName]);
    ...
    Bar.prototype._transformDataXCYV = function(xAxis, yAxis, legend, data) {
        var legendData = [];
        if  (legend) {
            $.each(data, function(index, item) {
                legendData.push(item[legend.fieldName]);
    ...
    Bar.prototype._getPluginID = function() {
        return PLUGIN_ID;
    };

    Bar.prototype._getName = function () {
        return "柱状图";
    };

    Bar.prototype._drawCtrlItems = function() {
		var item = [];
    ...
    Bar.prototype._initCtrlItems = function() {
    ...
    win.datavisual.plugin.Bar = win.datavisual.plugin.Bar || function(config, propertiesConfig) { return new Bar(config, propertiesConfig) };
}(jQuery, window));