...
var chooseComponent = function(node){
	...
	var divAttr = 'fieldtype='+node.colSty+' field='+node.column+' defaultvalue='+node.defaultVal;
	var compAttr = 'ms-attr-disabled="'+node.column+'_form_disabled" ms-duplex-string="'+node.column+'"';
	var checkboxAttr = 'name="sports" type="checkbox" ms-attr-disabled="'+node.column+'_form_disabled" ms-duplex-number="'+node.column+'_form_compute"';
